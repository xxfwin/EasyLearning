							...
							<div class="col-xs-12">
								...
								<form class="form-horizontal" action="" method="post" id="myform">
										...
										<div class="col-sm-3">
											...
											<select   class="form-control"  name="role_id" id="role">
												<option value="0">请选择权限</option>
												 <?php if(is_array($infoRole)): $i = 0; $__LIST__ = $infoRole;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><option value="<?php echo ($v["id"]); ?>" <?php if($info["role_id"] == $v['id']): ?>selected="selected"<?php endif; ?>><?php echo ($v["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
											</select>
									...
									<div class="form-group">
										...
										<label>	
											<input name="lock" type="radio" class="ace" value="锁定" <?php if($info["lock"] == '关闭'): ?>checked="checked"<?php endif; ?> />
