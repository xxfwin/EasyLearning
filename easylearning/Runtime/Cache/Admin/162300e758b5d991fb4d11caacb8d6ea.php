						...
						<div class="page-header">
						 <form action="" method="get">
									<!-- 	<div style="margin-bottom:10px;" class="col-sm-11">
										...
										<?php if($role == 1 or $role == 2): ?><a class="label label-xlg label-primary arrowed-right pull-right " href="<?php echo U('Incident/picupload',array('openid'=>$openid));?>">上传照片</a><?php endif; ?>
						 </form>
						</div>
												 ...
												 <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
														...
														<?php if($role == 1): ?><!--	<td>
																<div class="visible-md visible-lg hidden-sm hidden-xs btn-group">
																	...
																	<a onclick="if(confirm('确认删除?')) location.href='<?php echo U('Incident/delpic',array('id'=>$v[id]));?>'"  href="javascript:;"  class="btn btn-xs btn-danger">
