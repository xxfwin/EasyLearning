							...
							<div class="col-xs-12">
								...
								<form class="form-horizontal" action="" method="post" id="myform">
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="username" placeholder="管理员名称" class="col-xs-5" name="username"  />
									...
									<div class="form-group">
										...
										<div class="col-sm-3">
											...
											<select   class="form-control"  name="role_id" id="role">
												<option value="0">请选择权限</option>
												 <?php if(is_array($info)): $i = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><option value="<?php echo ($v["id"]); ?>"><?php echo ($v["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
											</select>
								  	...
								  	<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="form-field-2" placeholder="昵称" class="input-large"  name="nickname" value="<?php echo ($info["nickname"]); ?>" />
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="form-field-2" placeholder="电话" class="input-large"  name="phone" value="<?php echo ($info["phone"]); ?>" />
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="form-field-2" placeholder="工号" class="input-large"  name="worknumber" value="<?php echo ($info["worknumber"]); ?>" />
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
										<label>
											<input name="lock" type="radio" class="ace" value="开启" />
											<span class="lbl">&nbsp;开启</span>
										</label>
										<label>	
											<input name="lock" type="radio" class="ace" value="关闭" />
