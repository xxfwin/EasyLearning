				...
				<div class="main-content">
					...
					<div class="page-content">
						<div class="page-header">
						 <a class="label label-xlg label-primary arrowed " href="<?php echo U('Role/index');?>">
							返回列表</a>
							...
							<div class="col-xs-12">
								...
								<form class="form-horizontal" action="" method="post">
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="form-field-1" placeholder="角色名称" class="input-large" name="name"  value="<?php echo ($info["name"]); ?>" />
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="form-field-2" placeholder="角色描述" class="input-large"  name="remark" value="<?php echo ($info["remark"]); ?>" />
									...
									<div class="form-group">
										...
										<label>	
											<input name="status" type="radio" class="ace" <?php if($info["status"] == '关闭'): ?>checked=checked<?php endif; ?>value="关闭" />
